...
$kode = $_GET['kode'];
$data = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM db_barang WHERE kode='$kode'"));
?>
<!DOCTYPE html>
<html>
<head>
...
<body class="p-4">
  <div class="container">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
      ...
      $query = "UPDATE db_barang SET nama_barang='$nama', deskripsi='$deskripsi', harga_satuan='$harga', jumlah='$jumlah', foto='$foto_name' WHERE kode='$kode'";
